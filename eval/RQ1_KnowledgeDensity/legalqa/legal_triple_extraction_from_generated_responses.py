...
pipeline2a_legal.py
===================
Knowledge Graph Triple Extraction — Legal Domain
...
-------------------------------
  ...
  GED / SF / PAR / MA / triple-F1 / predicate-level metrics are out of
...
-----
  ...
  python pipeline2a_legal.py

  # explicit paths
  python pipeline2a_legal.py \\
      --input  /path/to/ALL_MODELS_responses_legal.xlsx \\
      --output /path/to/pipeline2a_legal_output.xlsx

  # override NLP model
  python pipeline2a_legal.py --nlp-model en_core_web_trf
...
DEFAULT_INPUT_FILENAME  = "ALL_MODELS_responses_legal.xlsx"
DEFAULT_OUTPUT_FILENAME = "pipeline2a_legal_output.xlsx"
...
LEGAL_CLASSES: Dict[str, str] = {
    ...
    "judgments":                            "legal:CourtCase",
    "decision":                             "legal:CourtCase",
    "decisions":                            "legal:CourtCase",
    "appeal":                               "legal:Appeal",
    "appeals":                              "legal:Appeal",
    "tribunal":                             "legal:Tribunal",
    "tribunals":                            "legal:Tribunal",
    # Parties
    "plaintiff":                            "legal:Plaintiff",
    "defendant":                            "legal:Defendant",
    "defendants":                           "legal:Defendant",
    "appellant":                            "legal:Appellant",
    "appellants":                           "legal:Appellant",
    "respondent":                           "legal:Respondent",
    "respondents":                          "legal:Respondent",
    "applicant":                            "legal:Applicant",
    "applicants":                           "legal:Applicant",
    "claimant":                             "legal:Claimant",
    "claimants":                            "legal:Claimant",
    ...
    "solicitors":                           "legal:Solicitor",
    "counsel":                              "legal:Counsel",
    "barrister":                            "legal:Barrister",
    "barristers":                           "legal:Barrister",
    "legal practitioner":                   "legal:LegalPractitioner",
    "legal practitioners":                  "legal:LegalPractitioner",
    "law society":                          "legal:LawSociety",
    # Legislation
    "act":                                  "legal:Act",
    "acts":                                 "legal:Act",
    "statute":                              "legal:Statute",
    "statutes":                             "legal:Statute",
    "legislation":                          "legal:Legislation",
    "regulation":                           "legal:Regulation",
    "regulations":                          "legal:Regulation",
    "statutory instrument":                 "legal:StatutoryInstrument",
    "airworthiness directive":              "legal:AirworthinessDirective",
    "airworthiness directives":             "legal:AirworthinessDirective",
    "amendment":                            "legal:Amendment",
    "amendments":                           "legal:Amendment",
    "section":                              "legal:Section",
    "sections":                             "legal:Section",
    "clause":                               "legal:Clause",
    "clauses":                              "legal:Clause",
    "provision":                            "legal:Provision",
    "provisions":                           "legal:Provision",
    "subsection":                           "legal:Subsection",
    "rule":                                 "legal:Rule",
    "rules":                                "legal:Rule",
    "code":                                 "legal:Code",
    "order":                                "legal:Order",
    ...
    "local court":                          "legal:LocalCourt",
    "family court":                         "legal:FamilyCourt",
    "court":                                "legal:Court",
    "courts":                               "legal:Court",
    # Sanctions and orders
    "charge":                               "legal:Charge",
    "charges":                              "legal:Charge",
    "offence":                              "legal:Offence",
    "offences":                             "legal:Offence",
    "offense":                              "legal:Offence",
    "sentence":                             "legal:Sentence",
    "sentences":                            "legal:Sentence",
    "penalty":                              "legal:Penalty",
    "penalties":                            "legal:Penalty",
    "fine":                                 "legal:Fine",
    "fines":                                "legal:Fine",
    ...
    "warrants":                             "legal:Warrant",
    "licence":                              "legal:Licence",
    "license":                              "legal:Licence",
    "licences":                             "legal:Licence",
    "certificate":                          "legal:Certificate",
    "certificates":                         "legal:Certificate",
    # Legal concepts
    "principle":                            "legal:LegalPrinciple",
    "principles":                           "legal:LegalPrinciple",
    "legal principle":                      "legal:LegalPrinciple",
    "legal principles":                     "legal:LegalPrinciple",
    "legal test":                           "legal:LegalTest",
    "precedent":                            "legal:Precedent",
    "precedents":                           "legal:Precedent",
    "finding":                              "legal:Finding",
    "findings":                             "legal:Finding",
    "reasoning":                            "legal:Reasoning",
    "argument":                             "legal:Argument",
    "arguments":                            "legal:Argument",
    "submission":                           "legal:Submission",
    "submissions":                          "legal:Submission",
    "ground":                               "legal:AppealGround",
    "grounds":                              "legal:AppealGround",
    "verdict":                              "legal:Verdict",
    "ruling":                               "legal:Ruling",
    "rulings":                              "legal:Ruling",
    "holding":                              "legal:Holding",
    "outcome":                              "legal:Outcome",
    "outcomes":                             "legal:Outcome",
    "result":                               "legal:Result",
    # Property and land
    ...
    "liabilities":                          "legal:Liability",
    "compliance":                           "legal:Compliance",
    "requirement":                          "legal:Requirement",
    "requirements":                         "legal:Requirement",
    "exemption":                            "legal:Exemption",
    "exemptions":                           "legal:Exemption",
    "exception":                            "legal:Exception",
    "exceptions":                           "legal:Exception",
    "restriction":                          "legal:Restriction",
    "restrictions":                         "legal:Restriction",
    "prohibition":                          "legal:Prohibition",
    "prohibitions":                         "legal:Prohibition",
    "permission":                           "legal:Permission",
    "consent":                              "legal:Consent",
    "approval":                             "legal:Approval",
    "authorization":                        "legal:Authorization",
    "authorisation":                        "legal:Authorization",
    "jurisdiction":                         "legal:Jurisdiction",
    "jurisdictions":                        "legal:Jurisdiction",
    # Australian jurisdictions
    "new south wales":                      "legal:NewSouthWales",
    "nsw":                                  "legal:NewSouthWales",
    "federal":                              "legal:Federal",
    "commonwealth":                         "legal:Commonwealth",
    "australia":                            "legal:Australia",
    "tasmania":                             "legal:Tasmania",
    "victoria":                             "legal:Victoria",
    "queensland":                           "legal:Queensland",
    "western australia":                    "legal:WesternAustralia",
    "northern territory":                   "legal:NorthernTerritory",
    # Disciplinary
    "misconduct":                           "legal:Misconduct",
    "professional misconduct":              "legal:ProfessionalMisconduct",
    "unsatisfactory professional conduct":  "legal:UnsatisfactoryProfessionalConduct",
    "disciplinary action":                  "legal:DisciplinaryAction",
    "reprimand":                            "legal:Reprimand",
    "suspension":                           "legal:Suspension",
    # Documents and records
    "document":                             "legal:Document",
    "documents":                            "legal:Document",
    "record":                               "legal:Record",
    "records":                              "legal:Record",
    "notice":                               "legal:Notice",
    "notices":                              "legal:Notice",
    "report":                               "legal:Report",
    "reports":                              "legal:Report",
    "statement":                            "legal:Statement",
    "statements":                           "legal:Statement",
    "witness":                              "legal:Witness",
    "witnesses":                            "legal:Witness",
    "expert witness":                       "legal:ExpertWitness",
    # Crimes and torts
    "crime":                                "legal:Crime",
    "crimes":                               "legal:Crime",
    "fraud":                                "legal:Fraud",
    "assault":                              "legal:Assault",
    "murder":                               "legal:Murder",
    "negligence":                           "legal:Negligence",
    "defamation":                           "legal:Defamation",
    "tort":                                 "legal:Tort",
    "torts":                                "legal:Tort",
    # Costs and compensation
    "costs":                                "legal:Costs",
    "legal costs":                          "legal:LegalCosts",
    "bill of costs":                        "legal:BillOfCosts",
    "compensation":                         "legal:Compensation",
    "award":                                "legal:Award",
    "awards":                               "legal:Award",
    "interest":                             "legal:Interest",
    # Interpretation
    "interpretation":                       "legal:Interpretation",
    "construction":                         "legal:Construction",
    "definition":                           "legal:Definition",
    "definitions":                          "legal:Definition",
    "meaning":                              "legal:Meaning",
    "test":                                 "legal:LegalTest",
    "standard":                             "legal:Standard",
    "standards":                            "legal:Standard",
    "criteria":                             "legal:Criteria",
    "criterion":                            "legal:Criterion",
}

LEGAL_OBJ_PROPS: Dict[str, str] = {
    "holds":            "legal:holds",
    "held":             "legal:holds",
    "found":            "legal:finds",
    "finds":            "legal:finds",
    "decided":          "legal:decides",
    "decides":          "legal:decides",
    "ruled":            "legal:rules",
    "rules":            "legal:rules",
    "determined":       "legal:determines",
    "determines":       "legal:determines",
    "dismissed":        "legal:dismisses",
    "dismisses":        "legal:dismisses",
    "allowed":          "legal:allows",
    "allows":           "legal:allows",
    "upheld":           "legal:upholds",
    "upholds":          "legal:upholds",
    "overturned":       "legal:overturns",
    "overturns":        "legal:overturns",
    "remitted":         "legal:remits",
    "remits":           "legal:remits",
    "awarded":          "legal:awards",
    "awards":           "legal:awards",
    "granted":          "legal:grants",
    "grants":           "legal:grants",
    "refused":          "legal:refuses",
    "refuses":          "legal:refuses",
    "ordered":          "legal:orders",
    "orders":           "legal:orders",
    "convicted":        "legal:convicts",
    "convicts":         "legal:convicts",
    "acquitted":        "legal:acquits",
    "acquits":          "legal:acquits",
    "sentenced":        "legal:sentences",
    "sentences":        "legal:sentences",
    "charged":          "legal:charges",
    "charges":          "legal:charges",
    "affirmed":         "legal:affirms",
    "affirms":          "legal:affirms",
    "reversed":         "legal:reverses",
    "reverses":         "legal:reverses",
    "varied":           "legal:varies",
    "varies":           "legal:varies",
    "remanded":         "legal:remands",
    "remands":          "legal:remands",
    "adjourned":        "legal:adjourns",
    "adjourns":         "legal:adjourns",
    "applies":          "legal:appliesTo",
    "applied":          "legal:appliesTo",
    "governed":         "legal:governedBy",
    "regulates":        "legal:regulates",
    ...
    "requires":         "legal:requires",
    "required":         "legal:requires",
    "must":             "legal:isMandatedTo",
    "shall":            "legal:isMandatedTo",
    "should":           "legal:shouldComplyWith",
    "may":              "legal:isPermittedTo",
    "can":              "legal:isPermittedTo",
    "cannot":           "legal:doesNotPermit",
    "prohibits":        "legal:prohibits",
    "breached":         "legal:breaches",
    "breaches":         "legal:breaches",
    "contravened":      "legal:contravenes",
    "contravenes":      "legal:contravenes",
    "infringed":        "legal:infringes",
    "infringes":        "legal:infringes",
    "complied with":    "legal:compliesWith",
    "complies with":    "legal:compliesWith",
    "comply with":      "legal:compliesWith",
    "sanctioned":       "legal:sanctions",
    "sanctions":        "legal:sanctions",
    "reprimanded":      "legal:reprimands",
    "reprimands":       "legal:reprimands",
    "suspended":        "legal:suspends",
    "suspends":         "legal:suspends",
    "struck off":       "legal:struckOff",
    "interprets":       "legal:interprets",
    "interpreted":      "legal:interprets",
    "construed":        "legal:construes",
    "considers":        "legal:considers",
    "considered":       "legal:considers",
    "examined":         "legal:examines",
    "reviews":          "legal:reviews",
    "reviewed":         "legal:reviews",
    "established":      "legal:establishes",
    "establishes":      "legal:establishes",
    "constitutes":      "legal:constitutes",
    "satisfied":        "legal:satisfies",
    "satisfies":        "legal:satisfies",
    "defines":          "legal:defines",
    "provides":         "legal:provides",
    "states":           "legal:states",
    "stated":           "legal:states",
    "enacted":          "legal:enacts",
    "enacts":           "legal:enacts",
    "prescribed":       "legal:prescribes",
    "prescribes":       "legal:prescribes",
    "directed":         "legal:directs",
    "directs":          "legal:directs",
    "contains":         "legal:contains",
    "includes":         "legal:includes",
    "filed":            "legal:files",
    "files":            "legal:files",
    "appealed":         "legal:appeals",
    "appeals":          "legal:appeals",
    "argued":           "legal:argues",
    "argues":           "legal:argues",
    "submitted":        "legal:submits",
    "submits":          "legal:submits",
    "contended":        "legal:contends",
    "contends":         "legal:contends",
    "alleged":          "legal:alleges",
    "alleges":          "legal:alleges",
    "relies on":        "legal:reliesOn",
    "relied on":        "legal:reliesOn",
    "leads to":         "legal:leadsTo",
    "results in":       "legal:resultsIn",
    "triggers":         "legal:triggers",
    "causes":           "legal:hasCause",
    "imposes":          "legal:imposes",
    "imposed":          "legal:imposes",
    "reduces":          "legal:reduces",
    "increases":        "legal:increases",
}
...
LEGAL_DATA_PROPS: Dict[str, str] = {
    ...
    "subsection":       "property:subsectionNumber",
    ...
    "costs":            "property:costsAmount",
    "rate":             "property:rate",
    "percentage":       "property:percentage",
    "number":           "property:number",
    "standard":         "property:standard",
    "requirement":      "property:requirementDetail",
    "notice period":    "property:noticePeriod",
    "effective date":   "property:effectiveDate",
}

LEGAL_MEREOLOGY: Dict[str, str] = {
    "part of":      "legal:partOf",
    "located in":   "legal:locatedIn",
    "inside":       "legal:locatedIn",
    "within":       "legal:locatedIn",
    "contained in": "legal:containedIn",
    "belongs to":   "legal:belongsTo",
    "component of": "legal:componentOf",
    "section of":   "legal:sectionOf",
    "subset of":    "legal:subsetOf",
    "under":        "legal:underJurisdictionOf",
    "included in":  "legal:includedIn",
    "subject to":   "legal:subjectTo",
    "governed by":  "legal:governedBy",
    "covered by":   "legal:coveredBy",
    "falls under":  "legal:fallsUnder",
    "pursuant to":  "legal:pursuantTo",
    "cited in":     "legal:citedIn",
}

LEGAL_LOGICAL: Dict[str, str] = {
...
# ---------------------------------------------------------------------------
# Blacklists and attribute qualifiers (extraction quality filters)
# ---------------------------------------------------------------------------
...
SUBJECT_BLACKLIST: Set[str] = {
    ...
    "relevant","appropriate","available","possible","likely","due","given",
...
ATTRIBUTE_QUALIFIERS: Set[str] = {
    "annual","monthly","weekly","daily","quarterly","minimum","maximum",
    "mandatory","optional","written","oral","electronic","domestic","foreign",
    "international","federal","state","local","regulatory","legal","statutory",
    "contractual","prior","advance","formal","informal","immediate","initial",
    "final","current","original","standard","default","approved","required",
    "permitted","prohibited","restricted","unlimited","limited","fixed","variable",
    "civil","criminal","administrative","procedural","equitable","common",
    "constitutional","judicial","interlocutory","interim","preliminary",
    "summary","indictable","appealable","enforceable",
}

NUMERIC_RE = re.compile(
    r"^\d[\d,\.]*\s*(?:%|percent|basis\s*points?|bps?|days?|months?|years?|"
    r"weeks?|hours?|aud|\$|million|billion|thousand|s\.\s*\d+)?$",
    re.I,
)
...
def _resolve_entity(surface: str) -> Tuple[str, str, float]:
    ...
    if key in SUBJECT_BLACKLIST or len(key) < 3:
        return key, f"legal:{_to_camel_case(key)}", 0.0
    if key in LEGAL_CLASSES:
        return key, LEGAL_CLASSES[key], 0.95
    for term in sorted(LEGAL_CLASSES, key=len, reverse=True):
        if len(term) >= 4 and term in key:
            return term, LEGAL_CLASSES[term], 0.85
    tokens = key.split()
    for tok in tokens:
        if len(tok) >= 4 and tok not in SUBJECT_BLACKLIST:
            if tok in LEGAL_CLASSES:
                return tok, LEGAL_CLASSES[tok], 0.75
            if tok.endswith("s") and tok[:-1] in LEGAL_CLASSES:
                return tok[:-1], LEGAL_CLASSES[tok[:-1]], 0.70
    slug = _to_camel_case(surface[:24])
    return surface.strip()[:40], f"legal:{slug}", 0.40
...
def _resolve_obj_prop(surface: str, negated: bool) -> Tuple[str, str]:
    ...
    for term in sorted(LEGAL_OBJ_PROPS, key=len, reverse=True):
        if term in normalised:
            uri = LEGAL_OBJ_PROPS[term]
            if negated:
                ns, loc = uri.split(":")
                uri = f"{ns}:doesNot{loc[0].upper()}{loc[1:]}"
            return term, uri
    slug = _to_camel_case(surface[:20])
    return surface[:30], f"legal:{slug}"


def _resolve_data_prop(surface: str) -> Tuple[str, str]:
    """Map a modifier token to its data-property URI."""
    normalised = str(surface).lower().strip()
    for term in sorted(LEGAL_DATA_PROPS, key=len, reverse=True):
        if term in normalised:
            return term, LEGAL_DATA_PROPS[term]
    slug = _to_camel_case(surface[:20]).capitalize()
    return surface[:30], f"property:has{slug}"
...
def _pass2_structural(doc: spacy.tokens.Doc) -> List[Triple]:
    ...
    STRUCT_PATTERNS = [
        (re.compile(r"\bgoverned\s+by\b",         re.I), "legal:governedBy"),
        (re.compile(r"\bregulated\s+by\b",         re.I), "legal:regulatedBy"),
        (re.compile(r"\bsupervised\s+by\b",        re.I), "legal:supervisedBy"),
        (re.compile(r"\bsubject\s+to\b",           re.I), "legal:subjectTo"),
        (re.compile(r"\bcovered\s+by\b",           re.I), "legal:coveredBy"),
        (re.compile(r"\bowned\s+by\b",             re.I), "legal:ownedBy"),
        (re.compile(r"\bcontrolled\s+by\b",        re.I), "legal:controlledBy"),
        (re.compile(r"\bprovided\s+by\b",          re.I), "legal:providedBy"),
        (re.compile(r"\bissued\s+by\b",            re.I), "legal:issuedBy"),
        (re.compile(r"\bpart\s+of\b",              re.I), "legal:partOf"),
        (re.compile(r"\bfalls?\s+under\b",         re.I), "legal:fallsUnder"),
        (re.compile(r"\bbelongs?\s+to\b",          re.I), "legal:belongsTo"),
        (re.compile(r"\bdefined\s+as\b",           re.I), "legal:definedAs"),
        (re.compile(r"\bdefined\s+in\b",           re.I), "legal:definedIn"),
        ...
        (re.compile(r"\bpursuant\s+to\b",          re.I), "legal:pursuantTo"),
        (re.compile(r"\bcited\s+in\b",             re.I), "legal:citedIn"),
        (re.compile(r"\bpresided\s+(?:over\s+)?by\b", re.I), "legal:presidedBy"),
        (re.compile(r"\bheard\s+by\b",             re.I), "legal:heardBy"),
        (re.compile(r"\bdecided\s+by\b",           re.I), "legal:decidedBy"),
        (re.compile(r"\brepresented\s+by\b",       re.I), "legal:representedBy"),
        (re.compile(r"\bamended\s+by\b",           re.I), "legal:amendedBy"),
        (re.compile(r"\brepealed\s+by\b",          re.I), "legal:repealedBy"),
        (re.compile(r"\bbased\s+on\b",             re.I), "legal:basedOn"),
        (re.compile(r"\bauthoris(?:ed|ed)\s+by\b", re.I), "legal:authorizedBy"),
        (re.compile(r"\bauthorized\s+by\b",        re.I), "legal:authorizedBy"),
        (re.compile(r"\bdelegated\s+by\b",         re.I), "legal:delegatedBy"),
        (re.compile(r"\bbound\s+by\b",             re.I), "legal:boundBy"),
        (re.compile(r"\brelied\s+on\b",            re.I), "legal:reliesOn"),
        (re.compile(r"\binterpreted\s+in\b",       re.I), "legal:interpretedIn"),
    ]
    triples: List[Triple] = []
    for sent in doc.sents:
        text = sent.text
        for pat, pred_uri in STRUCT_PATTERNS:
            m = pat.search(text)
            if not m:
                continue
            ...
            conf = round((sc + oc) / 2, 3)
            triples.append(Triple(
                subject=sl, predicate=m.group(0).strip().lower(),
                object=ol, subj_uri=su, pred_uri=pred_uri, obj_uri=ou,
    ...
    for token in doc:
        ...
        for child in token.head.children:
            if child.dep_ == "cc":
                ...
                break
        op_uri = LEGAL_LOGICAL.get(cc_text, "owl:intersectionOf")
...
def _pass5_causal(doc: spacy.tokens.Doc) -> List[Triple]:
    ...
    CAUSAL_RE = re.compile(
        r"(?P<subj>[A-Za-z ]{3,55}?)\s+"
        r"(?P<verb>leads?\s+to|results?\s+in|gives?\s+rise\s+to|triggers?"
        r"|causes?|drives?|produces?|increases?|decreases?|reduces?|entails?)\s+"
        r"(?P<obj>[A-Za-z ]{3,55})",
        re.I,
    )
    CAUSAL_URI_MAP: Dict[str, str] = {
        "lead":    "legal:leadsTo",    "leads":    "legal:leadsTo",
        "result":  "legal:resultsIn",  "results":  "legal:resultsIn",
        "give":    "legal:givesRiseTo","gives":    "legal:givesRiseTo",
        "trigger": "legal:triggers",   "triggers": "legal:triggers",
        "cause":   "legal:hasCause",   "causes":   "legal:hasCause",
        "drive":   "legal:drives",     "drives":   "legal:drives",
        "produce": "legal:produces",   "produces": "legal:produces",
        "increase":"legal:increases",  "increases":"legal:increases",
        "decrease":"legal:decreases",  "decreases":"legal:decreases",
        "reduce":  "legal:reduces",    "reduces":  "legal:reduces",
        "entail":  "legal:entails",    "entails":  "legal:entails",
    }
    triples: List[Triple] = []
    for sent in doc.sents:
        for m in CAUSAL_RE.finditer(sent.text):
            ...
            pred_uri = CAUSAL_URI_MAP.get(verb_key, "legal:leadsTo")
            conf     = round((sc + oc) / 2, 3)
            triples.append(Triple(
                subject=sl, predicate=m.group("verb").strip().lower(),
                object=ol, subj_uri=su, pred_uri=pred_uri, obj_uri=ou,
...
def load_ground_truth(xl: pd.ExcelFile) -> Dict[str, str]:
    ...
    if GROUND_TRUTH_SHEET not in xl.sheet_names:
        raise FileNotFoundError(
            f"Sheet '{GROUND_TRUTH_SHEET}' not found in workbook."
        )
...
def _parse_args() -> argparse.Namespace:
    ...
    parser = argparse.ArgumentParser(
        description="Legal domain triple extraction and TKF evaluation pipeline.",
    ...
    parser.add_argument(
        ...
        help=(
            ...
            "Defaults to <input_directory>/pipeline2a_legal_output.xlsx."
        ),
    )
    parser.add_argument(
        "--nlp-model",
...
def main() -> None:
    ...
    # Resolve output path: default alongside input file
    output_path: Path = (
        args.output.resolve()
        if args.output
    ...
    tmp_dir: Path = output_path.parent / "_p2a_legal_tmp"
    ...
    print(f"\n{'=' * 80}")
    print("  Pipeline 2A — Triple Extraction [Legal Domain]")
    ...
    # Global leaderboard
    print(f"\n\n{'=' * 80}")
    print("  GLOBAL LEADERBOARD  —  Pipeline 2A Legal  (TKF score)")
    print(f"{'=' * 80}")
    df_lb = (
        pd.DataFrame(all_ag)
        .sort_values("tkf_score_mean", ascending=False)
